...
let id = "minecraft-wolf"

let name = "Minecraft Wolf"
...
let textures: array<Generator.textureDef> = [
  ...
  {
    id: "Wolf Collar",
    url: requireTexture("wolf_collar"),
    standardWidth: 64,
    standardHeight: 32,
  },
]
...
let script = () => {
  ...
  Generator.defineTextureInput(
    "Wolf",
    {
      ...
      standardHeight: 32,
      choices: [
        "Stray Wolf", "Tame Wolf", "Angry Wolf"
      ],
    },
  )
  Generator.defineTextureInput(
  ...
  let drawWolf = (texture: string, tint: string) => {
    // Head
  ...
  drawWolf("Wolf", "None") // draw cat
  drawWolf("Collar", collarColor) // draw collar
